...
for f in imgs:
      ...
      cv2.createTrackbar('HMinY','Yellow Mask',0,179,null) # Hue is from 0-179 for Opencv
      ...
      cv2.createTrackbar('HMinG','Green Mask',0,179,null) # Hue is from 0-179 for Opencv
      ...
      while True:
         ...
         yellow_mask = filter_image(img, yellow_lower, yellow_upper)
         green_mask = filter_image(img, green_lower, green_upper)
